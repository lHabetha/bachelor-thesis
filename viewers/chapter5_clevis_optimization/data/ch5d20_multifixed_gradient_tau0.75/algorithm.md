...
The optimizer uses the canonical `blocked_200_v1` starts and the thesis-facing MLP checkpoint.
It writes public viewer schema v1 run artifacts. `trajectories.json` contains
