# 6.5 zig-zag (finish-line overlap + trust-region asm)

Chapter 6.5 strict alternating overlap/assemblability pipeline (v2, #5g), overlap variant `finish_line`, on `strict_overlap_blocked_v2`.

- Successful pipelines shown here: **9** (of 50 starts).
