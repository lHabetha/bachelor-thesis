...
Inputs are the active `blocked_200_v1` starts and the selected Chapter 4 MLP
artifact. Outputs follow Chapter 5 schema v1: `manifest.json`,
`trajectories.json`, `viewer_data.json`, `statistics.json`, and copied
`algorithm.md`.
